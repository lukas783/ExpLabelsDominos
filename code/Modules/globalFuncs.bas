...
Sub printLabel(item1 As String, item2 As String, usetype As String)
    ...
    If mainForm.Labels2.Value = "True" Then
        ...
        Print #1, "TEXT 2 40 125 " & usetype
        Print #1, "TEXT 2 40 150 DATE!"
        Print #1, "TEXT 2 40 185 " & mainForm.nameText.Text
        Print #1, "TEXT 3 40 220 EXPIRES"
        Print #1, "TEXT 4 40 260 date.."
    
        Print #1, "TEXT 3 450 20 " & item1
        Print #1, "TEXT 3 450 75 " & item2
        Print #1, "TEXT 2 450 125 " & usetype
        Print #1, "TEXT 2 450 150 DATE!"
        Print #1, "TEXT 2 450 185 " & mainForm.nameText.Text
